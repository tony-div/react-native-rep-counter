...
namespace margelo::nitro::repcounter {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/repcounter/Variant_NullType_String;";
  ...
  namespace JVariant_NullType_String_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/repcounter/Variant_NullType_String$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/repcounter/Variant_NullType_String$Second;";
